defmodule LissieWeb.StudentLiveTest do
  ...
  @create_attrs %{student_id: "some student_id", firstname: "some firstname", lastname: "some lastname", dob: "2025-07-16"}
  @update_attrs %{student_id: "some updated student_id", firstname: "some updated firstname", lastname: "some updated lastname", dob: "2025-07-17"}
  @invalid_attrs %{student_id: nil, firstname: nil, lastname: nil, dob: nil}

  setup :register_and_log_in_user

  defp create_student(%{scope: scope}) do
